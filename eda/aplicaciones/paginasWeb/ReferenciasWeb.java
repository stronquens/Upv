...
public class ReferenciasWeb implements Comparable<ReferenciasWeb> {
     ...
     */
    public int compareTo(ReferenciasWeb e) {
        // COMPLETAR 
        int res = 0;
        if (this.nohref > e.getNohref()){
            res = -1;
        } else if(this.nohref == e.getNohref()){
            if(this.nolineas > e.getNolineas()){
                res = -1;
            } else if (this.nolineas == e.getNolineas()){
                res = 0;
            } else {
                res = 1;
            }
