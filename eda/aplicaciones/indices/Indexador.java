...
public class Indexador {
    ...
    public ListaConPI<String> buscarPalabra(String pal) {
        ...
        ListaConPI<Indice> index = indicesBiblioteca.recuperar(pal.toLowerCase());
        ...
        if(index != null){
            ...
            for(index.inicio(); !index.esFin(); index.siguiente()){
                lista.insertar(index.recuperar().toString());
            }
        }
        return lista;   
    }
